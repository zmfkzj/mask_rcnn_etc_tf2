...
class TestModel(unittest.TestCase):
    ...
    def test_run_train_model(self):
        ...
        for data in loader:
            ...
            losses = \
                model.train_model([resized_image, resized_boxes, dataloader_class_ids,rpn_match, rpn_bbox, active_class_ids])
            print(losses)
            break
    ...
    def test_run_test_model(self):
        ...
        model = FasterRcnn(config).test_model
        for data in loader:
    ...
    def test_run_predict_model(self):
        ...
        model = FasterRcnn(config).predict_model
        for data in loader:
