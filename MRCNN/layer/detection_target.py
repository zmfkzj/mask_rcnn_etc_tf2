...
class DetectionTargetLayer(KL.Layer):
    ...
    def call(self, inputs, batch_size):
        ...
        outputs = tf.map_fn(lambda t: self.detection_targets_graph(*t, self.config),[proposals, gt_class_ids, gt_boxes, gt_masks], dtype=(tf.float32,tf.int32,tf.float32,tf.float32))
