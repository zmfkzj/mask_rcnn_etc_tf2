...
@tf.function
def refine_detections_graph(rois, probs, deltas, window, config: Config):
...
class DetectionLayer(KL.Layer):
    ...
    def call(self, rois, mrcnn_class, mrcnn_bbox, image_shape, window ):
        ...
        detections_batch = tf.vectorized_map(lambda x: refine_detections_graph(*x))([rois, mrcnn_class, mrcnn_bbox, window,self.config])
