...
class apply_box_deltas_graph(KL.Layer):
...
class clip_boxes_graph(KL.Layer):
    def call(self, boxes, window):
        """
        boxes: [N, (y1, x1, y2, x2)]
...
class ProposalLayer(KL.Layer):
    ...
    def __init__(self, nms_threshold, config=None, **kwargs):
        ...
        self.clip_boxes = clip_boxes_graph()
        self.apply_box_deltas = apply_box_deltas_graph()
    ...
    def call(self, inputs):
        ...
        # [batch, N, (y1, x1, y2, x2)]
        boxes = self.apply_box_deltas(pre_nms_anchors,deltas)
